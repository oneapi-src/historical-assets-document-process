...
class BidirectionalLSTM(nn.Module):
    """Creating a class for BidirectionalLSTM"""
    ...
    def forward(self, input):
        """This function creates the feed forward Network
        input params :input tensor"""
...
class CRNN(nn.Module):
    ...
    def forward(self, input):
        ...
        b, c, h, w = conv.size()  # pylint: disable=unused-variable
