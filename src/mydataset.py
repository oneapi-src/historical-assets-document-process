...
def randomColor(image):
    """This function performs Image transformations like Brightness and contrast enhancements on the image
...
def randomGaussian(image, mean=0.2, sigma=0.3):
    """
     This function performs Gaussian filtering on the image
    :param image:
    ...
    def gaussianNoisy(im, mean=0.2, sigma=0.3):
        ...
        input param : image ,mean and sigma
        output param :image
        """
...
def inverse_color(image):
    """ This function performs image inversion
    input params:image
...
def data_tf(img):
    """ This function performs image transformation
    input params:image
    output params : transformed image"""
...
def data_tf_fullimg(img, loc):
    """ This function crops the image based on the location
    input params: image and location
    output : transformed image""" 
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        """ This function returns the label of the specific index
        input :index value
        output :label and image"""
    ...
    def __len__(self):
        """This function returns the length of the label"""
...
class resizeNormalize2():
    # Create a class for resizing and normalizing the image
...
class resizeNormalize():
    # Creating a class to perform resizing and Normalizing operations
...
class randomSequentialSampler(sampler.Sampler):
    # Create a class for random Sequential Sampling
    ...
    def __iter__(self):
        """This function samples the data sequentially
          output params:list of indices"""
...
class alignCollate():
    # Create class to align and collate the images
    ...
    def __call__(self, batch):  # nosec
        """This function extracts the images from the batch and returns aligned and collated images
           Input param:batch of image
